...
export const PopupHome = ({ active, setActives }) => {

    return (
        <div className={active ? 'popup active' : "popup"} onClick={() => setActives(false)}>
            <div className="popup-content" onClick={(e) => e.stopPropagation()}>
                <div className="popup-title__wrapper">
                    <h3 className="popup__title">Пробная верисия</h3>
                    <img className="popup-cross" src={close} alt="close" onClick={() => setActives(false)} />
                </div>
